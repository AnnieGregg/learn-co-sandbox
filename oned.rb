def onedirection
  require "colorize"
  puts "Hey, welcome to our One Direction quiz. Take this to determine what iconic album you should listen to. Buzzfeed is QUAKING.".red
  
  puts "On a scale of 1-10, how much of a morning or night person are you? 1 is completely morning and 10 is completely night.".orange
  input1 = gets.chomp.to_i 
  
  puts "Who is better, Harry or Niall(Niall=5, Harry=10)?".yellow
